...
if(isset($_POST["edit"])){
	$sid=$_REQUEST["sid"];
	$s_name=$_REQUEST["subcat_name"];
	$sql="UPDATE subcategory SET sub_name='$s_name' WHERE sid=$sid";
...
<body>
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			...
			?>
						<h2 class="page-title">Edit subcategory name</h2>
...
$sql_query="SELECT * from subcategory where sid=$sid";
$result=mysqli_query($link,$sql_query) or die( mysqli_error($link));
	while($rows=mysqli_fetch_array($result)){
	
?>
													<input type="text" class="form-control" name="subcat_name" value="<?php echo $rows['sub_name']; ?>"  required>
													<?php }
}
?>
												</div>
