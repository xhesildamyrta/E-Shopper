...
?>
										<tr>
		                                    ...
		                                    <td><a href="edit-subcategory.php?sid=<?php echo $row['sid'];?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
											<a href="manage-subcategories.php?del=<?php echo $row['sid']; ?>"><i class="fa fa-close"></i></a>
											</td>
										</tr>
										<?php } ?>	
									</tbody>
